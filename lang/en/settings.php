...
$lang['incl_ns'] = 'Comma separated list of namespace ids where toggles should appear, without initial or final colons. If this option is set, the<code>xcl_ns</code> option will be ignored.'; 
